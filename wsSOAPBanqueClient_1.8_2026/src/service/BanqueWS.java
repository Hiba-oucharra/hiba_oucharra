 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8585?wsdl")
    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns BanqueServiceMap
     */
    @WebEndpoint(name = "BanqueServiceMapPort")
    public BanqueServiceMap getBanqueServiceMapPort() {
        return super.getPort(new QName("http://service/", "BanqueServiceMapPort"), BanqueServiceMap.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueServiceMapPort")
    public BanqueServiceMap getBanqueServiceMapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "BanqueServiceMapPort"), BanqueServiceMap.class, features);
    }
